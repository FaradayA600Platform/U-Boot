/*
 * board/faraday/tc12ngrc/clock.c
 *
...
{
	ulong ref_clk, pll0_out, ahb_clk;
...
{
	ulong ref_clk, pll0_out, apb_clk;
...
static inline ulong clk_get_rate_ssp(void)
{
	return clk_get_rate_apb();
}

static inline ulong clk_get_rate_mac(void)
{
	return 125 * 1000 * 100;
}
