...
int board_late_init(void)
{
	...
	if(CONFIG_FTGMAC030_BASE == FTGMAC030_0_BASE){
	...
	if(CONFIG_FTGMAC030_BASE == FTGMAC030_1_BASE){
		val = readl(FTSCU100_BASE+0x8070);
	...
	if(CONFIG_FTGMAC030_BASE == FTGMAC030_2_BASE){
		val = readl(FTSCU100_BASE+0x8070);
		//enable bit 15 gmac2_ck_src_en(RGMII)
		val |= 0x01<<15;
		writel(val,FTSCU100_BASE+0x8070);
	}
#endif
