...
/*                                                                    */
/*  Reference: ARM簧 Generic Interrupt Controller Architecture         */
...
#define GIC_GICD_BASE		(GICD_BASE)  /* GICD MMIO base address */
#define GIC_GICC_BASE		PLATFORM_CPU_PERIPHBASE
