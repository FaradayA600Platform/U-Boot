...
#if 1
u32 irq_start; 
void __iomem *gic_cpu_base_addr = (void *)(PLATFORM_CPU_PERIPHBASE + 0x2000); 
void __iomem *gic_dist_base_addr = (void *)(PLATFORM_CPU_PERIPHBASE + 0x1000); 
#else
u32 irq_start; 
u32 gic_cpu_base_addr = (u32 )(PLATFORM_CPU_PERIPHBASE + 0x2000); 
u32 gic_dist_base_addr = (u32 )(PLATFORM_CPU_PERIPHBASE + 0x1000); 
#endif
