...
int print_cpuinfo(void)
{
	...
	printf("AXI:   %u MHz\n",
		(unsigned int)(clock_get_rate(AXI_CLK) / 1000000));
...
{
	void __iomem *base = (void *)(PLATFORM_FTWDT010_BASE); 

	writel(0x00000000, base + 0x0c);
	writel(0x000003E8, base + 0x04);
	writel(0x00000003, base + 0x0c);	// system reset
	writel(0x00005AB9, base + 0x08);
}